...
<body class="bg-gradient-to-b from-green-500 via-black to-indigo-500 min-h-screen flex items-center justify-center">
        ...
        <div class="w-full">
            ...
            <form action="{{ route('store') }}" method="POST" autocomplete="off" class="p-2">
                ...
                <div class="flex flex-col justify-between p-2">
                    <input type="text" name="content" maxlength="70" placeholder="Add your Task" class="p-2 lg:w-3/4 min-w-full rounded-tr-md rounded-tl-md" required />
                    ...
                    <button type="submit" class="bg-blue-500 text-white p-2 w-auto h-full hover:bg-pink-500 transition-text duration-300 ease-in-out rounded-br-md rounded-bl-md">
